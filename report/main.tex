...
\newcommand{\thesistitle}{MPI-based Creation and Benchmarking of a Dynamic Elasticsearch Cluster}
\newcommand{\supervisor}{Hendrik Nolte}
...
\begin{itemize}
	...
	\item[\ccheckmark] Other, namely: Github Copilot
\end{itemize}
